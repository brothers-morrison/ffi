...
def blep(foo):
	try:
		...
		#print('########## DOMAINS ##########')
		#print('root: {:x}'.format(int(mono.mono_get_root_domain())&0xffffffffffffffff))
		#print('get: {:x}'.format(int(mono.mono_domain_get())&0xffffffffffffffff))
		#print('created: {:x}'.format(int(mono.mono_domain_create())&0xffffffffffffffff))
